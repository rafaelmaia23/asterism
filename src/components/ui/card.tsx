...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // `rounded-xl` virou `rounded-lg` na 3B: a §5 do design system dá 8px a cartão, e
        // `rounded-xl` caía no default do Tailwind — 12px —, porque `--radius-xl` não é
        // declarado no `globals.css`. Era a maior das três divergências de raio.
