 ...
 * forma da ADR-0025, a mesma da grade. A §10.5 prendia a identidade a "todos os slides
 ...
 * ADR-0015 vale para qualquer hairline dentro do slide, não só para a grade.
 *
 ...
 * tamanho apontaria — ADR-0018. Ela sai em `ink-200`,
 ...
 * ADR-0019 para a escala tipográfica: valor repetido em dez lugares diverge no terceiro.
 *
