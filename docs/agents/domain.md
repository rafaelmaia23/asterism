...
decisions; `docs/observatorio-design-system.md` and `docs/observatorio-templates.md` hold
the visual and template vocabulary. Those are written in Portuguese and are not meant to
